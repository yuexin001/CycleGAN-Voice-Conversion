...
if __name__ == '__main__':
    ...
    train(train_A_dir=train_A_dir, train_B_dir=train_B_dir, training_data_dir=training_data_dir, model_dir=model_dir,
          model_name=model_name, random_seed=random_seed, validation_A_dir=validation_A_dir,
          validation_B_dir=validation_B_dir, output_dir=output_dir)
