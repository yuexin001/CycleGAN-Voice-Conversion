...
def preprocess(train_A_dir, train_B_dir, training_data_dir, random_seed):
    ...
    np.savez(os.path.join(training_data_dir, 'logf0s_normalization.npz'), mean_A=log_f0s_mean_A, std_A=log_f0s_std_A,
             mean_B=log_f0s_mean_B, std_B=log_f0s_std_B)
    np.savez(os.path.join(training_data_dir, 'mcep_normalization.npz'), mean_A=coded_sps_A_mean, std_A=coded_sps_A_std,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_A_dir', type=str, default=train_A_dir_default)
    parser.add_argument('--train_B_dir', type=str, default=train_B_dir_default)
